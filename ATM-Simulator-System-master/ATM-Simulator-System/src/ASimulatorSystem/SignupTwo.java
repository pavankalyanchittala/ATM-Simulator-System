   ...
   String formno;
    ...
    SignupTwo(String formno ){
    	...
    	add(sno);
      	...
      	ButtonGroup maeitalgroup = new ButtonGroup();
     	maeitalgroup.add (syes);
     	maeitalgroup.add (sno);
    	...
    	eyes = new JRadioButton("Yes");
       	...
       	ButtonGroup emaeitalgroup = new ButtonGroup();
       	emaeitalgroup.add (eyes);
       	emaeitalgroup.add (eno);
